    ...
    try {
      ...
      if (endResponse.statusCode == 200) {
        ...
        if (reportResponse.statusCode == 200) {
          final Map<String, dynamic> reportData = json.decode(reportResponse.body);
          setState(() {
          ...
          if (sessionResponse.statusCode == 200) {
            final Map<String, dynamic> sessionData = json.decode(sessionResponse.body);
            setState(() {
  ...
  Map<String, dynamic> _extractSessionDetails(Map<String, dynamic> data) {
    ...
    try {
      ...
      if (data['startedAt'] != null && data['endedAt'] != null) {
        ...
        details['duration'] = '${minutes.toString().padLeft(2, '0')}:${seconds.toString().padLeft(2, '0')}';
      }
      ...
      } else if (data['statistics'] != null && data['statistics']['totalDistance'] != null) {
      ...
      if (data['events'] != null && data['events'] is List) {
        ...
        for (var event in events) {
          if (event['type'] != null) {
            ...
            if (type.contains('seatbelt') || type.contains('belt')) {
              ...
              if (phoneTime == null && createdAt.isNotEmpty) {
                try {
                  ...
                  phoneTime = '${time.hour.toString().padLeft(2, '0')}:${time.minute.toString().padLeft(2, '0')}';
                  if (time.hour < 12) {
                    phoneTime = '$phoneTime AM';
                  } else {
                    final hour = time.hour > 12 ? time.hour - 12 : time.hour;
                    phoneTime = '${hour.toString().padLeft(2, '0')}:${time.minute.toString().padLeft(2, '0')} PM';
                  }
                } catch (_) {
            ...
            } else if (type.contains('attention') || type.contains('distract')) {
  ...
  void _showSessionEndDialog(Map<String, dynamic> sessionData) {
    ...
    showDialog(
      ...
      builder: (context) {
        ...
        final dialogWidth = screenWidth * 0.85 > 400 ? 400.0 : screenWidth * 0.85;
                        ...
                        Column(
                          children: [
                            ...
                            _buildViolationRow(
                              'Phone in Hand',
                              details['violations']['Phone in Hand'],
                              details['violations']['Phone in Hand'] > 0 ? details['phoneViolationTime'] : null,
                            ),
                            const SizedBox(height: 16),
                            _buildViolationRow(
                              'Drowsiness',
